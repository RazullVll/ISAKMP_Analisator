//namespace должен соответствовать названию решения + папка проекта
//Например, если ты добавишь папку Settings в проект, то namespace для 
//модуля (класса) SettingsProvider будет ISAKMP_Analisator.Settings
